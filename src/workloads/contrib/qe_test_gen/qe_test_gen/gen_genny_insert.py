...
collections = {
    ...
    "pbl": CollectionDescription(
        "pbl",
        "All fields have values distributed as per the power-law with an added constraint that each field should have at least one value with frequencies in the following ranges: [1, 10], (10, 100], (100, 1k], (1k, 10k], (10k, 50k], (50k, 100k]",
        100,
    ),
}
