...
EXPERIMENTS = [
    {
        ...
        "updates": [
            {"query": {"field": "_id", "value": "fixed"}, "update": {"field": "fixed_10", "value": "fixed"}},
            {
                "query": {"field": "fixed_10", "value": "fixed_vlf"},
                "update": {
                    "field": "fixed_10",
                    "value": "uar",
                },
            ...
            {
                "query": {"field": "uar_[1,10]", "value": "uar_alllow"},
                "update": {"field": "uar_[1,10]", "value": "uar"},
            },
        ],
    },
    {
        ...
        "updates": [
            ...
            {
                "query": {"field": "uar_[6,10]", "value": "uar_alllow"},
                "update": {"field": "uar_[6,10]", "value": "uar"},
            },
        ],
    },
    {
        ...
        "contentionFactors": [1, 4, 8, 16],
        "updates": [
            {"query": {"field": "_id", "value": "fixed"}, "update": {"field": "fixed_1", "value": "fixed"}},
            {
                "query": {"field": "fixed_1", "value": "fixed_vlf"},
                "update": {
                    "field": "fixed_1",
                    "value": "uar",
                },
            ...
            {
                "query": {"field": "uar_[1,5]", "value": "uar_alllow"},
                "update": {"field": "uar_[1,5]", "value": "uar"},
            },
        ],
    },
    {
...
def main():
    ...
    parser.add_argument(
        "-d", "--destination", action="store", default="workload", help="Destination to write workload files"
    )
